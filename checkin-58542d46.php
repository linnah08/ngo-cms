...
$rows = $pdo->query("
    SELECT ticket_code, ticket_path, ticket_qty, name, created_at, amount_eur, pledge_type
    FROM campaign_pledges
    WHERE pledge_type IN ('ticket', 'donation')
...
$donor_count = count(array_filter($tickets, fn($t) => $t['is_donor']));
...
<div class="screen-header">
    ...
    <span class="meta">Генериран <?= $generated ?> &nbsp;·&nbsp; <?= $total - $donor_count ?> билета &nbsp;+&nbsp; <?= $donor_count ?> дарители &nbsp;·&nbsp; <?= number_format($total_eur, 2, '.', ' ') ?> EUR</span>
...
<div class="print-header">
    <h1>Списък с билети</h1>
    <p>Генериран <?= $generated ?> &nbsp;·&nbsp; <?= $total - $donor_count ?> билета &nbsp;+&nbsp; <?= $donor_count ?> дарители &nbsp;·&nbsp; <?= number_format($total_eur, 2, '.', ' ') ?> EUR</p>
</div>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= h($t['name']) ?></td>
            <td class="mono"><?php if ($t['is_donor']): ?><span style="font-family:Arial,sans-serif;font-size:7pt;font-weight:bold;color:#000;letter-spacing:.05em;">ДАРИТЕЛ</span><?php else: ?><?= h($t['ticket_code']) ?><?php endif; ?></td>
    ...
    <tfoot>
        <tr>
            <td colspan="4">Общо: <?= $total - $donor_count ?> билета + <?= $donor_count ?> дарители</td>
