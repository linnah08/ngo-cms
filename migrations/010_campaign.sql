...
INSERT INTO campaign_rewards (position, title, description, amount_eur, active) VALUES
    (1, 'Малък приятел',    'Лафетки пакет — малък',   25.00, 1),
    (2, 'Среден приятел',   'Лафетки пакет — среден',  50.00, 1),
    (3, 'Голям приятел',    'Лафетки пакет — голям',  100.00, 1),
    (4, 'Голям поддръжник', 'Лафетки пакет — пълен',  250.00, 1);
